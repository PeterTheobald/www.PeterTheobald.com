...
categories: [ tech ]
tags: [ "python", "forensics", "programming"]
---
...
I recommend using the excellent and free [VLC media player](https://www.videolan.org/vlc/index.html) to view video and display the subtitles.

This program is written in Python, and calls ffmpeg to do the video conversion. You can grab the source code on [Dav2Mp4's github page](https://github.com/PeterTheobald/Dav2Mp4) . If all you want to do is USE the program, you can save yourself the trouble of installing Python and the ffmpeg binaries by grabbing the installation package I've put together with pyinstaller as a [github release](https://github.com/PeterTheobald/Dav2Mp4/releases). You install it by unzipping the ZIP file into a folder and run it by double-clicking on dav2mp4.exe (Windows only for now, sorry).
